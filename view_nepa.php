...
<script>
$(function(){
$("#page_show").load("ajax_view_nepa.php");

//PAGE NUMBER onClick FUNCTION
$(".page").live("click", function(){
var page = $(this).attr("id");
$("#page_show").load("ajax_view_nepa.php?page="+page);
});
});
</script>
...
$("#page_show").load("ajax_view_nepa.php?searchvalue="+searchvalue);
  });
});
</script>
<?php
...
if($result === FALSE) {
 ...
 if(!mysql_query("delete FROM nepa where id=$id"))
{
die('Error: ' . mysql_error());
}
 echo '<div class="success_message">Nepa deleted successfully</div>';
...
&nbsp;
<div class="header_bold">View Nepa</div>
<br/>
<br/>
<br/>
