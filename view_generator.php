...
<script>
$(function(){
$("#page_show").load("ajax_viewgenerator.php");

//PAGE NUMBER onClick FUNCTION
$(".page").live("click", function(){
var page = $(this).attr("id");
$("#page_show").load("ajax_viewgenerator.php?page="+page);
});
});
</script>
...
$("#page_show").load("ajax_viewgenerator.php?searchvalue="+searchvalue);
  });
});
</script>
<?php
...
die('Error: ' . mysql_error());
 ...
 echo '<div class="success_message">generator deleted successfully</div>';
