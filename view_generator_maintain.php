...
<script>
$(function(){
$("#page_show").load("ajax_viewgenerator_maintain.php");

//PAGE NUMBER onClick FUNCTION
$(".page").live("click", function(){
var page = $(this).attr("id");
$("#page_show").load("ajax_viewgenerator_maintain.php?page="+page);
});
});
</script>
...
$("#page_show").load("ajax_viewgenerator_maintain.php?searchvalue="+searchvalue);
  });
});
</script>
<?php
...
die('Error: ' . mysql_error());
 ...
 echo '<div class="success_message">generator maintenance  deleted successfully</div>';
...
&nbsp;
<div class="header_bold">View Generator</div>
<br/>
<br/>
<br/>
