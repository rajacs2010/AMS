...
<script>
$(function(){
$("#content").load("ajax_state.php");

//PAGE NUMBER onClick FUNCTION
$(".page").live("click", function(){
var page = $(this).attr("id");
$("#content").load("ajax_state.php?page="+page);
});
});
</script>
<script>
...
$("#content").load("ajax_state.php?searchvalue="+searchvalue);
  });
});
</script>
</script>
...
echo '<div class="success_message">state created successfully</div>';
}
else
{
...
echo '<div class="success_message">state  updated successfully</div>';
}
else
{
echo '<div class="error_message">The name should not be empty</div>';
...
&nbsp;
<form id='state_save' action="<?php echo $_SERVER['PHP_SELF'];?>" onsubmit="return validateForm()"  method='post' accept-charset='UTF-8'>
                    ...
                    <tr>
                       <td  width="150px"><label style="margin-left:0px;">state<em style="font-style:normal;color:red;">*</em></label></td>
						...
						<?php if(isset($_GET['id'])){ ?>
							<input type='text' name='state' id='state' class="textbox" value="<?php echo $name; ?>"/>
