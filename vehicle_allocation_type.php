...
if ($vehicle_reg_id!= "")
{
if(!mysql_query('INSERT INTO vehicle_allocation_type (vehicle_reg_id,status_id,created_by)VALUES ("'.$vehicle_reg_id.'","'.$status_id.'","'.$user_id.'")'))
{
...
if ($vehicle_reg_id != "")
{
if(!mysql_query('UPDATE vehicle_allocation_type SET vehicle_reg_id="'.$vehicle_reg_id.'",status_id="'.$status_id.'",updated_at="'.$current_date.'",updated_by="'.$user_id.'" WHERE id="'.$edit_id.'" '))
{
die('Error: ' . mysql_error());
}
