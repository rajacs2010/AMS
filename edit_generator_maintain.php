...
?>
<span class="success_message">Generator maintain updated  successfully</span>
<?php
}
             ...
             <!-- The inner table below is a container for form -->
                <table style="font-family:Arial;" width="100%"  cellpadding="10px" class="htmlForm" cellspacing="0" border="0">
					...
					<tr>
                        ...
                        <td>
						<input type='text' name='mduedate' id='mduedate' class="textbox"  value="<?php echo $due_date;?>"/>
                        ...
                        <td>
						<input type='text' name='status' id='status' class="textbox" value="<?php echo $status;?>" />
					...
					<tr>
                        ...
                        <td>
						<input type='text' name='donedate' id='donedate' class="textbox" value="<?php echo $done_date;?>"/>
						</td>
						<td  width="150px"><label style="margin-left:0px;">Next Due Date<em style="font-style:normal;color:red;">*</em></label></td>
                        <td>
						<input type='text' name='nextduedate' id='nextduedate' class="textbox" value="<?php echo $next_due_date;?>"/>
						</td>
					
					
						<td  width="150px"><label style="margin-left:0px;">Description<em style="font-style:normal;color:red;">*</em></label></td>
                        <td>
						<textarea name='desc' id='desc' class="textbox"><?php echo $description;?></textarea>
						</td>
					...
					<td  width="150px"><label style="margin-left:0px;">Additional Cost<em style="font-style:normal;color:red;">*</em></label></td>
                        <td>
					<input type='text' name='addcost' id='addcost' class="textbox" value="<?php echo $cost;?>"/>
						</td>
