...
<script>
$(function(){
$("#page_show").load("ajax_view_diesel.php");

//PAGE NUMBER onClick FUNCTION
$(".page").live("click", function(){
var page = $(this).attr("id");
$("#page_show").load("ajax_view_diesel.php?page="+page);
});
});
</script>
...
$("#page_show").load("ajax_view_diesel.php?searchvalue="+searchvalue);
  });
});
</script>
<?php
...
if($result === FALSE) {
 ...
 if(!mysql_query("delete FROM diesel where id=$id"))
{
die('Error: ' . mysql_error());
}
 echo '<div class="success_message">Diesel consumption deleted successfully</div>';
...
&nbsp;
<div class="header_bold">View Diesel consumption</div>
<br/>
<br/>
<br/>
